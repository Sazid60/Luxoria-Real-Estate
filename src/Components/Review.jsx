    ...
    return (
        <div>
            ...
            <div className="flex flex-col lg:flex-row gap-6 max-w-5xl mx-auto mb-6 mt-6">
                ...
                <div className="bg-white rounded-lg overflow-hidden shadow-md">
                    <div className="relative">
                        <img className="h-16 w-16 rounded-full mx-auto mt-4" src="/reviewer-3.jpg" alt="Reviewer" />
                        <div className="absolute bottom-0 left-0 bg-white rounded-full p-1"></div>
                        <div className="flex justify-center mt-2 "><FaStar className="text-yellow-400"/><FaStar className="text-yellow-400" /><FaStar className="text-yellow-400"/><FaStar className="text-yellow-400"/><FaStar className="text-yellow-400"/></div>
                    </div>
                    <div className="px-4 py-2">
                        <p className="text-sm text-gray-600 italic">
                            <span className="quotes text-base">&quot;</span>The apartment we found on this website is perfect for our needs. It's in a great neighborhood with good schools nearby. The layout of the apartment is ideal for our family. We highly recommend it!<span className="quotes text-base">&quot;</span>
                        </p>
                    </div>
                </div>
            </div>
