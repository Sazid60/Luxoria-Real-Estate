    ...
    return (
        <div>
            ...
            <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-4 mx-auto lg:mt-7 rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 ">
                <div className="flex flex-col justify-between" data-aos="fade-right" data-aos-duration="500" data-aos-delay="320">
                ...
                <form noValidate="" className="space-y-3" data-aos="fade-left" data-aos-duration="500" data-aos-delay="320">
                    <div>
            ...
            <div className="w-full" >
                <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
                    ...
                    <div className="space-y-4">
                        <details className="w-full rounded-lg border border-gray-300" data-aos="fade-up" data-aos-duration="500" data-aos-delay="400" >
                        ...
                        <details className="w-full rounded-lg border border-gray-300" data-aos="fade-up" data-aos-duration="500" data-aos-delay="500" >
                        ...
                        <details className="w-full rounded-lg border border-gray-300" data-aos="fade-up" data-aos-duration="500" data-aos-delay="600" >
                        ...
                        <details className="w-full rounded-lg border border-gray-300" data-aos="fade-up" data-aos-duration="500" data-aos-delay="700" >
                        ...
                        <details className="w-full rounded-lg border border-gray-300" data-aos="fade-up" data-aos-duration="500" data-aos-delay="800" >
