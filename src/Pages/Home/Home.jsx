        ...
        <div className="mt-6">
            ...
            <div className='
                mt-3  flex flex-col md:flex-row lg:flex-row lg:items-center justify-around text-left p-6'>
                    ...
                    <div>
                        <h1><span className='text-xl md:text-2xl lg:text-4xl font-bold'>800+</span>  <br /> <span className='text-[#E1B453] text-lg md:text-xl lg:text-2xl font-semibold'>Active Listing</span></h1>
                    </div>
                </div>
                <hr className="border-gray-700 my-4 opacity-40" />
